...
Firebase is the API used in this project, it provides authentication so that the user can sign in to their account, it also provides a service which enables the user to reset their password in case they have forgotten