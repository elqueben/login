...
Firebase provided this projects' API which made this a  project fun to work with, it's API provides a source of authentication to sign in users, sign up users and to reset their passwords.