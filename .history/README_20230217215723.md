...
Firebase provided this API which made this project fun to work with, it's API provides a source of authentication to sign in users, sign up users and to reset their passwords.